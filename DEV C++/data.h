...
#define Menu_Ret5 21	// 退出游戏 
#define Read_Name 6 	// 是否读入用户名 
#define Del_Gif 7		// 是否展示消除动画
#define Name_Ret 8		// 输入交互信号变量 
#define Name_Remand 9	// 提示用户输入用户名 
#define Is_Tool 10		// 是否在工具栏界面 
#define Is_End 11		// 游戏是否结束 
#define Is_Save 12		// 是否有存档 
#define Is_Rank 13		// 是否显示排行榜 
#define Is_Help	14		// 是否显示帮助 
#define Is_Quit	22		// 是否退出游戏 
#define Tool_Ret1 15	// 新游戏
#define Tool_Ret2 16	// 继续游戏
#define Tool_Ret3 17	// 排行榜
#define Tool_Ret4 18	// 帮助
#define Tool_Ret5 19	// 保存并退出 
#define Is_Back 20		// 返回 
